...
export const CompetitiveAdvantage = ({ enableIntroVideo }: CompetitiveAdvantageProps = { enableIntroVideo: false }) => {
    return (
        <Stack>
            <StackItem className='pf-u-mx-auto pf-u-mb-4xl' style={{maxWidth: 900}}>
                <Flex direction={{ default: "columnReverse", md: "row" }} flexWrap={{default: "nowrap"}} alignItems={{md: "alignItemsCenter"}} spaceItems={{default: "spaceItems2xl", md: "spaceItems4xl"}}>
                    {enableIntroVideo && (
                        <FlexItem className='pf-u-w-50-on-md'>
                            <iframe
                            style={{borderRadius: "15px", width: "100%", height: "12rem"}}
                        ...
                        <Flex className='pf-u-text-align-center' justifyContent={{ default: "justifyContentCenter" }}>
                            ...
                            <FlexItem>
                                <Text component={TextVariants.p}>
                                    ...
                                    The project was developed to take advantage of <Button style={{ textDecoration: "underline" }} component="a" href="https://kubernetes.io/" variant='link' isInline>Kubernetes</Button> running
                                    on the <Button style={{ textDecoration: "underline" }} component="a" href="https://www.redhat.com/en/technologies/cloud-computing/openshift" variant='link' isInline>Red Hat OpenShift Container Platform</Button>.
                                </Text>
                            </FlexItem>
                        </Flex>
                    </FlexItem>
            ...
            <StackItem className='pf-u-mx-auto'>
                <Flex spacer={{ default: "spacerLg" }} direction={{ default: "column", md: "row" }} flexWrap={{ default: "nowrap" }}>
                    <FlexItem>
                        <Stack>
                            <StackItem>
                                <img src={logo} alt='Open Data Hub logo' style={{ overflow: "hidden", height: 45 }} />
                            </StackItem>
                            <StackItem>
