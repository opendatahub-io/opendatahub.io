...
const LINKED_CONTENT: LinkedContent[] = [
  ...
  {
    title:
      "Kubecon 2020: How to Use Kubernetes to Build a Data Lake for AI Workloads",
  ...
  {
    title:
      "Kubecon 2020: Is There a Place For Distributed Storage For AI/ML on Kubernetes?",
      ...
      children: [
        {
          title: "ODH Operator",
          description:
            "ODH Operator image now includes a local copy of the release version of the ODH Core deployment manifests that can be referenced from any supported kfdef",
        },
        {
          title: "ODH Dashboard",
      ...
      children: [
        {
          title: "ODH Operator",
          description:
            "Default to the `rolling` OLM release channel and deprecate `stable`",
        },
        {
          title: "ODH Dashboard",
        ...
        },
        {
          title: "Distributed Workloads",
          description:
            "Incubation of the Distributed Workloads stack supporting the CodeFlare SDK",
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          title: "Data Science Pipelines operator",
          description:
            "Adds support for namespace isolation of Data Science Pipelines",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          description:
            "Includes ability to install Kubeflow v1.5.0 components on OpenShift <br> Support for the integration of Service Mesh with Kubeflow v1.5 on OpenShift",
        },
      ],
    },
    {
