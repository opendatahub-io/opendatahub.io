...
To contribute to the project knowledge of operators and operator development is important. For a getting started guide on operator development please visit the [operator sdk github link](https://github.com/operator-framework/operator-sdk). We also provide the following two development guides for beginners:
